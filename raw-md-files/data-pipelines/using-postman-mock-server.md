...
- Three JSON files included with this project:
  ...
  | File | Purpose |
  |---|---|
  | [`DataPipeline-Environment.json`](pathname:///software/downloads/mock-postman-json/DataPipeline-Environment.json) | Defines reusable variables: `dd_site`, `mock_base_url`, and `dd_api_key`. |
  | [`DataPipeline-postman-collection.json`](pathname:///software/downloads/mock-postman-json/DataPipeline-postman-collection.json) | Sends real requests to the Datadog Log Ingestion API (`/api/v2/logs`). |
  | [`DataPipeline-MockServer-Collection.json`](pathname:///software/downloads/mock-postman-json/DataPipeline-MockServer-Collection.json) | Configures mock responses for the same endpoints using a Postman mock server. |

Download all three sample files:
- [DataPipeline-Environment.json](pathname:///software/downloads/mock-postman-json/DataPipeline-Environment.json)
- [DataPipeline-postman-collection.json](pathname:///software/downloads/mock-postman-json/DataPipeline-postman-collection.json)
- [DataPipeline-MockServer-Collection.json](pathname:///software/downloads/mock-postman-json/DataPipeline-MockServer-Collection.json)

You can also [view the sample files on GitHub](https://github.com/pvega62/software/tree/main/downloads/mock-postman-json).
...
body. The Datadog Log Ingestion API requires this field.
...
|---|---|---|
| Test with the real Datadog | `DataPipeline-postman-collection.json` | `{{dd_site}}` → `datadoghq.com` |
