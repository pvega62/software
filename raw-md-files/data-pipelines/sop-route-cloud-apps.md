...
**Goal**: send a mock app log, verify pipeline ingestion, and prepare it for routing to destinations like Splunk, Elasticsearch, or Amazon S3.
...
If you see `status: accepted` (HTTP 202 Accepted), the pipeline received the data.
...
| Issue / Status Code | Potential Cause / Resolution |
| :--- | :--- |
